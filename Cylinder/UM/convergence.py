        ...
        for igrid,grid in zip(range(len(case_grids)),case_grids):
            for iorder,order in zip(range(len(case_orders)),case_orders):
                for itime,time in zip(range(len(case_times)),case_times):
                    ...
                    case_file = 'Quad-'+motion+'-'+physic+'-'+grid+'-'+order+'/'+time+'_TimeHist.txt'
...
for imotion,motion in zip(range(len(case_motions)),case_motions):
    for iphysic,physic in zip(range(len(case_physics)),case_physics):
        for iorder,order in zip(range(len(case_orders)),case_orders):
            ...
            if (motion == 'M1'):
                if (physic == 'Re3'):
                    ax_M1_1.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M1_2.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M1_3.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re2'):
                    ax_M1_4.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M1_5.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M1_6.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re1'):
                    ax_M1_7.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M1_8.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M1_9.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
            elif (motion == 'M2'):
                if (physic == 'Re3'):
                    ax_M2_1.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M2_2.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M2_3.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re2'):
                    ax_M2_4.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M2_5.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M2_6.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re1'):
                    ax_M2_7.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M2_8.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M2_9.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
            elif (motion == 'M3'):
                if (physic == 'Re3'):
                    ax_M3_1.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M3_2.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M3_3.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re2'):
                    ax_M3_4.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M3_5.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M3_6.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re1'):
                    ax_M3_7.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M3_8.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M3_9.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
            elif (motion == 'M4'):
                if (physic == 'Re3'):
                    ax_M4_1.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M4_2.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M4_3.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re2'):
                    ax_M4_4.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M4_5.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M4_6.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                elif (physic == 'Re1'):
                    ax_M4_7.semilogx(sndofs,xI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M4_8.semilogx(sndofs,yI[imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
                    ax_M4_9.semilogx(sndofs,W[ imotion,iphysic,:,iorder,itime],color,linewidth=1.0,label=order)
...
ax_M1_2.set_ylim((-0.014,-0.01))
ax_M1_3.set_ylim((-0.012,-0.005))
ax_M1_4.set_ylim((-0.1e-03,0.1e-03))
ax_M1_5.set_ylim((-0.020,-0.01))
ax_M1_6.set_ylim((-0.012,-0.005))
ax_M1_7.set_ylim((-0.1e-03,0.1e-03))
ax_M1_8.set_ylim((-0.030,-0.000))
ax_M1_9.set_ylim((-0.012,-0.005))

ax_M2_1.set_ylim((-0.1e-10,0.1e-10))
ax_M2_2.set_ylim((-0.1e-10,0.1e-10))
ax_M2_3.set_ylim((-0.1e-9,0.1e-9))
ax_M2_4.set_ylim((-0.1e-10,0.1e-10))
ax_M2_5.set_ylim((-0.1e-10,0.1e-10))
ax_M2_6.set_ylim((-0.12,-0.1))
ax_M2_7.set_ylim((-0.1e-10,0.1e-10))
ax_M2_8.set_ylim((-0.1e-10,0.1e-10))
ax_M2_9.set_ylim((-0.20,-0.10))
...
M3.savefig('UM_convergence_motion3.png', bbox_inches='tight', dpi=800)
M4.savefig('UM_convergence_motion4.png', bbox_inches='tight', dpi=800)
